...
//标记己方下子位置
void Mark(int x0, int y0, int x, int y)
{
    x0 = x0 * 2; y0 = y0 * 4;
    buffer[x0 - 1][y0 - 2] = ' ';
    buffer[x0 - 1][y0 + 2] = ' ';
...
//判断下子位置是否出界
int Basic_condition(int x, int y)
{
...
//评分标准
long Assessment(int num1, int num2)
{
    if (num2 == 0)//判断电脑五元组得分
    {
        switch (num1)
